...
type SiteAdminTitleQueryQueryVariables = Exact<{ [key: string]: never; }>;


type SiteAdminTitleQueryQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null };
