...
const ResearchCard = ({ children, title, link }: CardProps) => (
...
const ResearchPage = () => (
  <>
    <Seo
      title="Research | Keith B. Kelly"
      description="Saxophonist and educator Keith Kelly articles 'A New Cartography: Learning Jazz at the Dawn of the 21st Century' and 'Jazz Band Teaching Guide'"
    />
    <ResearchCard
